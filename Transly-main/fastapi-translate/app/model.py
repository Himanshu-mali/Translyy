...
def translate_with_model(bundle: Dict[str, Any], text: str, source_lang: str, target_lang: str = "en") -> str:
    """
    Translate text from source_lang to target_lang.
    
    Args:
        bundle: Model bundle with tokenizer, model, device
        text: Text to translate
        source_lang: Source language code ("ne", "si", "en", etc.)
